...
<html lang="en">
  <head>
    ...
    <title>Add Creative | Admin Area | XenaPedia</title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Add Creative</h1>
          ...
          <?php
            $atts = array('id' => 'creative_add', 'role' => 'form');
            echo form_open('admin/creatives/add', $atts);
          ?>
            <select id="offer_id" name="offer_id" class="form-control" required>
              ...
              <?php foreach($offers as $offer) : ?>
                <option value="<?php echo $offer->offer_id ?>"><?php echo "$offer->offer ($offer->offer_code)"; ?></option>
              <?php endforeach; ?>
            </select>
            <br>
            ...
            <input id="code" name="code" placeholder="Code of creative" class="form-control" required>
            <br>&nbsp;
            ...
            <textarea id="creative" name="creative"></textarea>
            <button class="btn btn-lg btn-primary btn-block" type="submit">Add Creative</button>
          <?php echo form_close(); ?>
