...
<?php foreach ($wiki as $wiki_item): ?>
        <tr><td><?php echo $wiki_item['id']; ?></td>
            
            <td><?php echo $wiki_item['title']; ?></td>
            <td><?php echo $wiki_item['text']; ?></td>
            <td>
                <a href="<?php echo site_url('admin/wiki/view/'.$wiki_item['id']); ?>">View</a> | 
                <a href="<?php echo site_url('admin/wiki/edit/'.$wiki_item['id']); ?>">Edit</a> | 
                <a href="<?php echo site_url('admin/wiki/delete_row/'.$wiki_item['id']); ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a>
            </td>
        </tr>
<?php endforeach; ?>
</table>
