...
<html lang="en">
  <head>
    ...
    <title>View Creative | Members Area | Xenapedia</title>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <ul class="nav nav-tabs">
            <li role="presentation"<?php if(!$html) echo' class="active"'; ?>><?php echo anchor('user/creatives/view/'.$creative->creative_id, 'View Formatted Creative'); ?></li>
            <li role="presentation"<?php if($html) echo' class="active"'; ?>><?php echo anchor('user/creatives/view/'.$creative->creative_id.'/html', 'View HTML'); ?></li>
          </ul>
          <p>
          <?php if(!$html) : ?>
