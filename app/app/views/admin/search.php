...
<html lang="en">
  <head>
    ...
    <title>"<?php echo $search ?>" | Search Results | Admin Area | XenaPedia</title>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo anchor('admin/creatives/view/'.$creative->creative_id, 'View'); ?> | <?php echo anchor('admin/creatives/view/'.$creative->creative_id.'/html', 'HTML'); ?> | <?php echo anchor('admin/edit/creative/'.$creative->creative_id,'Edit'); ?></td>
                </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
