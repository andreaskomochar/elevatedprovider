    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <?php endif; ?>
          <h1 class="page-header">Elastic email</h1>
          ...
          <div class="row">
            ...
            <div class="col-xs-6 col-sm-3">
              <span class="metric"><?php echo $this->Campaign_model->count_verticals(); ?></span>
          ...
          <h2 class="sub-header">List of all Emails</h2>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $campaign->vertical; ?></td>
                  <td><?php echo $campaign->offer; ?> (<?php echo $creative->offer_code; ?>)</td>
                  <td><?php echo $campaign->campaign_code; ?></td>
                  <td>
                    <?php
                      if(null !== $campaign->campaign_tags) {
                        $tags_used = explode(',',$campaign->campaign_tags);
                      } else {
                        $tags_used = FALSE;
                      }
                      if($tags_used) {
                  ...
                  <td><?php echo date('Y-m-d h:i A', strtotime($campaign->campaign_edited) ); ?></td>
                  <td><?php echo date('Y-m-d h:i A', strtotime($campaign->campaign_created) ); ?></td>
                  <td><?php echo anchor('admin/creatives/view/'.$campaign->campaign_id, 'View'); ?> | <?php echo anchor('admin/campaigns/view/'.$campaign->campaign_id.'/html', 'HTML'); ?> | <?php echo anchor('admin/edit/campaign/'.$campaign->campaign_id,'Edit'); ?></td>
                </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
