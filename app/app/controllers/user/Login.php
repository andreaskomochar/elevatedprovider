		...
		if ($this->form_validation->run() == FALSE){
			 ...
			 // Get Post Data
				...
				$recaptcha_fields = array(
						'secret'   => "6LfX-xgUAAAAAAgf09fVv1-0ONV6nADJtdwmEG4Y",
				...
				if(ENVIRONMENT == 'production' && isset($response) && $response->success && $recaptcha_post_body['success'] && $recaptcha_post_body['hostname'] == 'elevatedprovider.com') {
